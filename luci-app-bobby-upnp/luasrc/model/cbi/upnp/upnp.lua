...
e = s:taboption(
    ...
    Flag,
    "enabled",
    translate("Start UPnP and NAT-PMP service")
)
e.rmempty = false
...
s:taboption(
    ...
    Flag,
    "enable_upnp",
    translate("Enable UPnP functionality")
).default = "1"
...
s:taboption(
    ...
    Flag, 
    "enable_natpmp",
    translate("Enable NAT-PMP functionality")
).default = "1"
...
s:taboption(
    ...
    Flag, 
    "igdv1", 
    translate("Enable IGDv1 mode"),
    translate("Advertise as IGDv1 device instead of IGDv2")
).default = "0"
...
s:taboption(
    ...
    Flag, 
    "log_output",
    translate("Enable additional logging"),
...
s:taboption(
    ...
    Flag, 
    "system_uptime",
    translate("Report system instead of daemon uptime")
).default = "1"
...
s:taboption(
    ...
    Value, 
    "uuid", 
    translate("Device UUID")
)
s:taboption(
    "advanced", 
    Value, 
    "serial_number",
    translate("Announced serial number")
)
s:taboption(
    "advanced", 
    Value, 
    "model_number",
    translate("Announced model number")
)
...
ct = s:taboption(
    ...
    translate("Clean rules threshold")
)
...
ci = s:taboption(
    ...
    translate("Clean rules interval")
)
